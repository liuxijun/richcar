...
import com.fortune.util.core.SimpleSSLSocketFactory;
import com.fortune.util.net.http.HttpHandler;
import com.fortune.util.net.http.RequestCallBack;
import com.fortune.util.net.http.RetryHandler;
import com.fortune.util.net.http.SyncHttpHandler;
...
import com.fortune.util.net.http.client.ResponseStream;
import com.fortune.util.net.http.client.callback.HttpRedirectHandler;
import com.fortune.util.net.http.client.entity.GZipDecompressingEntity;
	...
	public HttpUtils(int connTimeout) {
		...
		try {
			if(ComParams.userAgent!=null){
				configUserAgent(ComParams.userAgent);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		httpClient.addResponseInterceptor(new HttpResponseInterceptor() {
			@Override
			public void process(HttpResponse response, HttpContext httpContext) throws HttpException,
                    IOException {
