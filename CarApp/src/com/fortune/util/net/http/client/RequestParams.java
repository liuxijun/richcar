...
package com.fortune.util.net.http.client;

import com.fortune.util.ULog;
import com.fortune.util.net.http.client.entity.BodyParamsEntity;
import com.fortune.util.net.http.client.multipart.HttpMultipartMode;
import com.fortune.util.net.http.client.multipart.MultipartEntity;
import com.fortune.util.net.http.client.multipart.content.ContentBody;
import com.fortune.util.net.http.client.multipart.content.FileBody;
import com.fortune.util.net.http.client.multipart.content.InputStreamBody;
import com.fortune.util.net.http.client.multipart.content.StringBody;
