...
package com.fortune.util.net.http.client.util;
...
public class URLEncodedUtils {
	...
	/**
	 * Returns a list of {@link NameValuePair NameValuePairs} as built from the URI's query portion. For
	...
	/**
	 * Returns a list of {@link NameValuePair NameValuePairs} as parsed from the given string using the
