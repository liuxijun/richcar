 ...
 * APIs provided by the <code>java.util.concurrent</code> pacakge such as {@link Executor},
...
public abstract class CompatibleAsyncTask<Params, Progress, Result> {
	 ...
	 * pool of threads managed by AsyncTask, however you can also use your own {@link Executor} for
	 * custom behavior.
	 * <p/>
	 * <p>
