 ...
 * 导入山西数据
 */
public class SxImportor extends ImportDb {
    public SxImportor() {
        ...
        user =  config.getConfig("importor.desertUser","rms_sx");
        pwd =  config.getConfig("importor.desertPwd","rms_sx");
/*
...
//        SqlUtils.executeSQL("update content_property set display_order=id", getDesertConnection());
    ...
    public void content() throws Exception {
        ...
        String selectSql = "select m.media_id,1,ms.server_id,media_impid*1000," +
                ...
                " from media m,media_server ms where m.media_id=ms.media_id";
    ...
    public void content_property_exec() throws Exception {
        ...
        //先导入影片连接信息
        String selectSql = "select FORTUNE_GLOBAL_SEQ.nextval,mediaclip_mediaid,11,mediaclip_volume,mediaclip_url,mediaclip_length,mediaclip_name from media_clip" +
...
//            ipRange();
    ...
    public static void main(String[] args) {
        SxImportor importor = new SxImportor();
        importor.doImport();
    }
