...
public class TimerBase implements Runnable{
    ...
    public static ScheduledExecutorService scheduExec = Executors.newScheduledThreadPool(10);
    ...
    public void setTimer(final Runnable task,String timerStr){
        ...
        if ("minute".equals(timeUnit)){
            for (int i=0; i<times.length; i++){
                ...
                System.out.println("minute:"+StringUtils.date2string(calendar.getTime()));
        ...
        if ("hour".equals(timeUnit)){
            for (int i=0; i<times.length; i++){
                ...
                System.out.println("hour:"+StringUtils.date2string(calendar.getTime()));
                long delay = (calendar.getTime().getTime() - System.currentTimeMillis())/1000;
        ...
        if ("day".equals(timeUnit)){
            for (int i=0; i<times.length; i++){
                ...
                System.out.println("day:"+StringUtils.date2string(calendar.getTime()));
                long delay = (calendar.getTime().getTime() - System.currentTimeMillis())/1000;
        ...
        if ("week".equals(timeUnit)){
            for (int i=0; i<times.length; i++){
                ...
                System.out.println("week:"+StringUtils.date2string(calendar.getTime()));
                long delay = (calendar.getTime().getTime() - System.currentTimeMillis())/1000;
        ...
        if ("month".equals(timeUnit)){
            for (int i=0; i<times.length; i++){
                ...
                System.out.println("month:"+StringUtils.date2string(calendar.getTime()));
                long delay = (calendar.getTime().getTime() - System.currentTimeMillis())/1000;
                ...
                Runnable runCommand = new Runnable() {
                    public void run() {
                        ...
                        System.out.println("month:"+StringUtils.date2string(calendar1.getTime()));
