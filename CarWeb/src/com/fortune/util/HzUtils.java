...
public class HzUtils {
	...
	/**
	 * »ñµÃµ¥¸öºº×ÖµÄAscii£¬²¢ÓÃ"-"Á¬½Ó³ÉÒ»¸ö×Ö·û´®
	 *
	 * @param cn char ºº×Ö×Ö·û
	 * @return string ´íÎó·µ»Ø ¿Õ×Ö·û´®,·ñÔò·µ»Øascii
	 */
	...
	/**
	 * ¸ù¾ÝASCIIÂëÁ¬½Ó³ÉµÄ×Ö·û´®µ½SpellMapÖÐ²éÕÒ¶ÔÓ¦µÄÆ´Òô
	 *
	 * @param ascii ×Ö·û¶ÔÓ¦µÄASCIIÁ¬½ÓµÄ×Ö·û´®
	 * @return String Æ´Òô,Ê×ÏÈÅÐ¶ÏÊÇ·ñÊÇÖÐÎÄÈç¹ûÊÇÓ¢ÎÄÖ±½Ó·µ»Ø×Ö·û£¬Èç¹ûÊÇÖÐÎÄ·µ»ØÆ´Òô,
	 *
	...
	public static String getFullSpell(String cnStr)
	{
		...
		for (int i = 0, Len = chars.length; i < Len; i++) {
			...
			if (ascii.length() == 0) { // È¡asciiÊ±³ö´í
	...
	/**
	 * »ñÈ¡ººÓï×Ö·û´®µÄÉùÄ¸×éºÏ£¬Ã¿¸öºº×ÖÈ¡Æ´ÒôµÄµÚÒ»¸ö×Ö·û×é³ÉµÄÒ»¸ö×Ö·û´®
	 * @param cnStr ºº×ÖµÄ×Ö·û´®
	 * @return Ã¿¸öºº×ÖÆ´ÒôµÄµÚÒ»¸ö×ÖÄ¸Ëù×é³ÉµÄºº×Ö
	 */
	public static String getFirstSpell(String cnStr)
	{
		...
		for (int i = 0, Len = chars.length; i < Len; i++) {
			...
			if (ascii.length() == 1) { // È¡asciiÊ±³ö´í
				retuBuf.append(chars[i]);
			} else {
	...
	public static void main(String[] args) {
		...
		String str = null;
		str = "åÖãÆÀÖ";
		System.out.println("Spell=" + HzUtils.getFullSpell(str));
		System.out.println("Spell=" + HzUtils.getFirstSpell(str));
		Date end = new Date();
