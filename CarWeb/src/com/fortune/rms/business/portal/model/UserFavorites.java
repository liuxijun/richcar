 ...
 */
public class UserFavorites implements java.io.Serializable {
	...
	public UserFavorites(long id) {
		this.id = id;
	}
	public UserFavorites(long id, Long cspId, Long contentId, String userId,
