                ...
                var errorMsg = "您目前无法正常播放此节目，可能是以下原因造成的：\n"+
                                ...
                                " 4.请检查你的网络连接是否正常通畅。\n"+
                                "谢谢！！";
                function setButtonImg(NowStat){
                   switch(NowStat){
                      case 1: //stoped
                          imgPlaySrc= imgPath + "bofang.gif";
                          imgStopSrc= imgPath + "tingzhiing.gif";
                          imgPauseSrc= imgPath + "zanting.gif";
                         break;
                      case 2:
                          imgPlaySrc= imgPath + "bofang.gif";
                          imgStopSrc= imgPath + "tingzhi.gif";
                          imgPauseSrc= imgPath + "zantinging.gif";
                         break;
                      case 3:
                          imgPlaySrc= imgPath + "bofanging.gif";
                          imgStopSrc= imgPath + "tingzhi.gif";
                          imgPauseSrc= imgPath + "zanting.gif";
                         break;
                      default:
                          imgPlaySrc= imgPlay.src;
                          imgStopSrc= imgStop.src;
                          imgPauseSrc= imgPause.src;
                         break;
                   }
                   imgPlay.src = imgPlaySrc;
                   imgPause.src = imgPauseSrc;
                   imgStop.src = imgStopSrc;
                   //outStates( program.status );
                }
...
if (event.button==1&&dragapproved){
   ...
   if(newPosX <=0 || newPosX > movelen){
      return;
   }
   //trackball.style.pixelLeft=newPosX
   rcp=newPosX * getDuration() / movelen;
   outStates(CalculateTime(rcp,true) + "/" + CalculateTime(getDuration(),true));
   return false
}}
function drags(){
...
dragapproved=true
//z=event.srcElement
//temp1=trackball.style.pixelLeft
//temp2=trackball.style.pixelTop
x=event.clientX
y=event.clientY
