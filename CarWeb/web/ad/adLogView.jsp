...
<head>
    ...
    <script type="text/javascript">
        ...
        function initDisplay() {
            ...
            var adLogViewForm = new FortuneViewForm({
                title:'<fts:text name="adLog"/>基本信息',
                url:'adLog!save.action',
                saveUrl:'adLog!save.action',
                viewUrl:'adLog!view.action',
                items:[
            ...
            loadFormAjax();
            adLogViewForm.render(displayDiv);
        }
