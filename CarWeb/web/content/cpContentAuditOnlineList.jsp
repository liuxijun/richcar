...
<%
    ...
    String actionHeader = "admin";
    {
        ...
        needPermissions(actionHeader,"AuditOnlineView","contentCpAuditOnline");
        needPermissions(actionHeader,"cpAuditSearch","contentCpAuditOnline,contentCpAuditSearch");
        needPermissions(actionHeader,"contentAudit","contentContentAudit,contentCpAuditOnline");
...
%>
    ...
    var dataListStore = new Ext.data.JsonStore({
        method:'POST',
        remoteSort: true,
        url: actionUrl + "!cpAuditSearch.action?ca_type=2&cadmin_cpOnline=1&&cadmin_adminId=" + adminId,
    ...
    var listGrid = new Ext.grid.GridPanel({
        ...
        columns: [
            ...
            },
            {
                ...
                renderer:
                        function (val, p, row) {
                            if(canDoThisAction('AuditOnlineView')){
