...
--%><%@ page contentType="text/html;charset=UTF-8" language="java" %><%
    ...
    if(contentId>0){
        try {
            ...
            result = "http://tv.inhe.net/page/hbMobile/detail4phone.jsp?contentId="+contentId+"&time="+time+"&key="+token+"&isSpecial=true";
            success = true;
            ...
            systemLogLogicInterface.saveLog(request.getRemoteAddr(),admin,"getContentZtUrls.jsp","获取专题连接：contentId="+contentId+","+content.getName());
        } catch (Exception e) {
