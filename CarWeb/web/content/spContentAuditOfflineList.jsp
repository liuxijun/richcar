...
//        needPermissions(actionHeader,"list","deviceList");
        needPermissions(actionHeader,"OfflineContentView","contentSpAuditOffline");
        needPermissions(actionHeader,"contentAudit","contentContentAudit");
        needPermissions(actionHeader,"spAuditSearch","systemSpContentAuditOnlineList");
    }
...
%>
    ...
    var listGrid = new Ext.grid.GridPanel({
        ...
        columns: [
            checkSelect,
                {header: "ID", dataIndex: 'c_id', width: 50, hidden:true, sortable: true, align:'center'},
                {header: "名称", dataIndex: 'c_name', width: 130, sortable: true, align:'center',
                    renderer:
                        function (val,p,row){
                            if(canDoThisAction('OfflineContentView'))   {
                ...
                {header: "CP", dataIndex: 'c_cspId', width: 95, sortable: true, align:'center',
                    renderer:function(val,p,row){
                ...
                {header: "SP", dataIndex: 'cc_cspId', width: 60, sortable: true, align:'center',
                    renderer:function(val,p,row){
                        var objs = cspStore.reader.jsonData.objs;
                        if (objs){
                            for (var i=0; i<objs.length; i++){
