...
<%
    ...
    String actionHeader = "admin";
    {
        ...
        needPermissions(actionHeader,"contentAuditOnlineView","contentSpAuditOnline");
         needPermissions(actionHeader,"contentAudit","contentContentAudit,contentSpAuditOnline");
    }
...
%>
    ...
    var dataListStore = new Ext.data.JsonStore({
            method:'POST',
            remoteSort: true,
            //url: "/content/content!spSearch.action?c_status=2&cc_status=0&cc_cspId="+spId,
            url: actionUrl + "!spAuditSearch.action?ca_type=4&cadmin_spOnline=1&cadmin_adminId="+adminId,        
    ...
    var listGrid = new Ext.grid.GridPanel({
        ...
        columns: [
            checkSelect,
                ...
                {header: "名称", dataIndex: 'c_name', width: 140, sortable: true, align:'center',
                    renderer:
                        function (val,p,row){
                            if(canDoThisAction('contentAuditOnlineView')){
                ...
                {header: "CP", dataIndex: 'c_cspId', width: 105, sortable: true, align:'center',
                    renderer:function(val,p,row){
                ...
                {header: "SP", dataIndex: 'cc_cspId', width: 105, sortable: true, align:'center',
                    renderer:function(val,p,row){
                        var objs = cspStore.reader.jsonData.objs;
                        if (objs){
                            for (var i=0; i<objs.length; i++){
                ...
                {header: "设备", dataIndex: 'c_deviceId', width: 90, sortable: true, align:'center',
                    renderer:function(val,p,row){
