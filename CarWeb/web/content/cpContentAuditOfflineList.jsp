...
<%
    ...
    String actionHeader = "admin";
    {
        ...
        needPermissions(actionHeader,"AuditOfflineView","contentCpAuditOffline");
        needPermissions(actionHeader,"cpAuditSearch","contentCpAuditOffline,contentCpAuditSearch");
        needPermissions(actionHeader,"contentAudit","contentContentAudit,contentCpAuditOffline");
...
%>
    ...
    var dataListStore = new Ext.data.JsonStore({
        method:'POST',
        remoteSort: true,
        url: actionUrl + "!cpAuditSearch.action?ca_type=1&cadmin_cpOffline=1&cadmin_adminId=" + adminId,
    ...
    var listGrid = new Ext.grid.GridPanel({
        ...
        columns: [
            ...
            },
            {
                ...
                renderer:
                        function (val, p, row) {
                            if(canDoThisAction('AuditOfflineView')){
