...
//        needPermissions(actionHeader,"searchAll","channelSearchAll");
        ...
        needPermissions(actionHeader,"RecycleBinView","SpRecycleBinManage");
...
Ext.onReady(function () {
    ...
    var dataListStore = new Ext.data.JsonStore({
        method:'POST',
        remoteSort:true,
        url:"/content/content!spSearch.action?c_status=2&cc_status=8&cc_cspId=" + spId,
        ...
        columns:[
            ...
            {header:"名称", dataIndex:'c_name', width:130, sortable:true, align:'center',
                renderer:function (val, p, row) {
                    if(canDoThisAction('RecycleBinView'))      {
            ...
            {header:"资源模版", dataIndex:'c_moduleId', width:80, sortable:true, align:'center',
                renderer:function (val, p, row) {
            ...
            {header:"入库时间", dataIndex:'c_createTime', width:108, sortable:true, align:'center'},
            {header:"CP状态", dataIndex:'c_status', width:75, sortable:true, align:'center', renderer:function (val, p, row) {
                switch (parseInt(val)) {
                    case 1:
                        return '下线';
                    case 2:
            ...
            {header:"SP状态", dataIndex:'cc_status', width:75, sortable:true, align:'center',
                renderer:function (val, p, row) {
                    switch (parseInt(val)) {
                        case 0:
                            return '新资源';
            ...
            {header:"设备", dataIndex:'c_deviceId', width:60, sortable:true, align:'center',
                renderer:function (val, p, row) {
