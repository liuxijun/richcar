...
<script language="javascript">
    ...
    var contentName;
    var contentId;
    var clipStore=new Ext.data.SimpleStore();
    var checkRow ;
    var keyIds="";
...
Ext.onReady(function () {
    ...
    this.loadData = function () {
        ...
        dataListStore.load({params:{start:listGrid.toolbars[1].cursor,limit:pageSize}});
                                ...
                                Ext.MessageBox.confirm("请您确认操作", " 申请下线 ", function (btn) {
                                    if (btn == "yes") {
                                        ...
                                        var remoteRequestStore = new Ext.data.JsonStore({
                                            method:'POST',
                                            url:actionUrl + "!spApplyOffline.action"
                                        });
                                        remoteRequestStore.reload({
                                            params:{keyIds:keyIds, spId:spId, status:6},
                                            callback:function (records, options, success) {
