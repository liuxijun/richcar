...
%>
    ...
    var dataListStore = new Ext.data.JsonStore({
        method:'POST',
        remoteSort: true,
        //url: "/content/content!spSearch.action?cc_status=0&cc_cspId="+spId,
    ...
    cspComboStore.load({params:{adminId:adminId,auditType:'spOnline',cspType:'isSp', start:0, limit:10000000}});
