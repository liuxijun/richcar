...
<%
    ...
    //    needPermissions(actionHeader,"getCspModuleList","moduleGetCspModuleList");
        ...
        needPermissions(actionHeader,"cpAuditSearch","contentCpAuditSearch");
...
%>
    ...
    cspComboStore.load({params:{adminId:adminId,auditType:'cpOffline',cspType:'isCp', start:0, limit:10000000}});
