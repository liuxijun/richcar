...
<%
   ...
   //     needPermissions(actionHeader,"list","contentModuleList");
        needPermissions(actionHeader,"newContentView","spNewContentManage");
        needPermissions(actionHeader,"spSearch","spNewContentManage,systemContentSpSearch");
        needPermissions(actionHeader,"spRecycle","contentSpRecycle");
        needPermissions(actionHeader,"spDelete","contentSpDelete");
        needPermissions(actionHeader,"spOffline","contentSpOffline");
    }
%>
    ...
    var listGrid = new Ext.grid.GridPanel({
        ...
        columns: [
            ...
            },
            {
                ...
                renderer:
                        function (val, p, row) {
                            if(canDoThisAction('newContentView')){
