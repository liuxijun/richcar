        ...
        _trigger : function (eventType) {
            ...
            if (eventType === "scroll") {
                if (me.page < me.maxPage) {
                    ...
                    if (me.$triggerTarget.scrollTop() >= contentHeight - winHeight * (1 + 1.5) && !isLoading && !isNoMore) {
...
//全局变量
    ...
    var $img = $("#screenshot-slider").find("img");
    var HXRequest;
    var TG = "&uc_param_str=dnfrpfbivesscpmibtbmntnisiei";
    var ApiURL = "http://tz.m.app.uc.cn/upremind/frontlog.php";
            ...
            if ( appsInfo.length > 0 ) {
                ...
                function renderList( JSON ){
                    ...
                    if ( updateNum > 0 ){
                        ...
                        var now = new Date();
                        var H = now.getHours();
                        setCookie( "updateNum", updateNum, "day", "/" );
                        setCookie( "clock", H, "day", "/" );
    ...
    function changeState(){
        ...
        function navDisplay(){
            ...
            if ( updateNum !== null && parseInt(updateNum) >= 0 ) {
                ...
                setCookie( "updateNum", upNums, "day", "/" );
                if( upNums === 0 ){
                    $badge.hide();
                }
            }
...
//            $("body").prepend("up-6>")
            ...
            //读取 ucweb API 失败
//        $("body").prepend("up-7>")
//        $.get( "http://dws.test.waptw.com:9091/upremind/frontlog.php",{ imei: ei, sn: sn });
...
//    apiDone( 4 );
        ...
        function apiDone( upcount ){
            ...
            setCookie( "updateNum", upcount, "day", "/" );
            setCookie( "clock", H, "day", "/" );
        }
    })();
