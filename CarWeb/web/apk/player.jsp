...
--%><%@ page contentType="text/html;charset=UTF-8" language="java" %><%
    ...
    String apkFileName = "InhePlayer_1.2.5.0.apk";
    String apkVersion = "1.2.4.0";
...
<div class="100%"><img src="images/01_3.png" width="100%" height="52"></div>
<div class="wrapper">
    <header class="sub-hd">
    ...
    <ul class="v-soft-list down-page">
        <li>
            <div class="icon"><img src="resource/phoneApkImage.png"><i class=""></i></div>
            <div class="info">
                <h2>燕赵视界   V<%=apkVersion%></h2>
    ...
    <div class="soft-info">
        <div class="introduce J_info" style="height: 57px;margin-top: 15px;">“燕赵视界”是河北联通为移动终端用户全心打造的视频业务，也是河北联通本地移动视频门户。燕赵视界客户端为移动终端带来更好的业务体验。</div>
    </div>
    <%
        if(fromClient){
%>
    ...
    <div style="width:100%"><img src="images/copyright_phone_b.jpg" width="100%" height="16%"></div>
</div>
