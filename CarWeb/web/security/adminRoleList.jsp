<%@ taglib prefix="s" uri="/struts-tags" %><%@ taglib prefix="fts" uri="/WEB-INF/tlds/fortune-tags.tld" %><%@ taglib
    ...
    //初始化本页权限需求
    String actionHeader = "operatorRole";
    {
        session.setAttribute("actionHeader",actionHeader);
    }
%><%@include file="../inc/checkHeader.jsp"%><head>
    ...
    <script type="text/javascript">
        ...
        Ext.onReady(function() {
            Ext.QuickTips.init();
            storeConfig.fields = ['id','operatorid','roleid'];
            ...
            var columns = new Ext.grid.ColumnModel([
                ...
                {header: "<fts:text name="operatorRole.operatorid"/>",hidden:false, align:'center', width: 60, sortable: true,dataIndex: 'operatorid'}                ,
                {header: "<fts:text name="operatorRole.roleid"/>",hidden:false, align:'center', width: 60, sortable: true,dataIndex: 'roleid'},
            ...
            var operatorRoleGrid = new FortuneSearchListGrid({
                title:'<fts:text name="operatorRole"/>列表',
                sm : sm,
                cm:columns,
                store:searchStore,
            ...
            operatorRoleGrid.render(displayDiv);
            defaultGrid = operatorRoleGrid;
