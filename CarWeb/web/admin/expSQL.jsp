...
--%><%@ page contentType="text/html;charset=UTF-8" language="java" %><%
    ...
    String connectionUrl = "jdbc:sqlserver://12.110.250.36:1030;databasename=mdnb10d04;selectMethod=cursor";
    String username = "redex";
    String password="redex";
...
*/
        String sqlStr = "select * from content_info where channel_id in('26','31') and submit_time>'2010-12-08 00:00:00'";
