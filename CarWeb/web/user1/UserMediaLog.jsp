...
%><%@ page import="java.util.Date,
 ...
 contentType="text/html;charset=gb2312" %><%
    ...
    //定义数据访问变量
     String mediaName = ParamTools.getParameter(request,"medianame1","");
     Date startTime1 = ParamTools.getDateParameter(request,"start_time1",StringTools.date2string(System.currentTimeMillis()-24L*3600L*1000L));
     long startTime = startTime1.getTime();
     Date endTime1   = ParamTools.getDateParameter(request,"end_time1",StringTools.date2string(System.currentTimeMillis()));
     long endTime = endTime1.getTime();
     long icpId     = ParamTools.getLongParameter(request,"icp_id1",-1);
     long impId     = ParamTools.getLongParameter(request,"imp_id1",-1);
     long channelId     = ParamTools.getLongParameter(request,"channel_id1",-1);
     String orderBy = ParamTools.getParameter(request,"order_by1","m.mediaName");
     String orderDirectory = ParamTools.getParameter(request,"order_dir1","desc");
     ...
     searchHelper = UserLogLogic.getUserMediaLog(channelId,userid,startTime,endTime,icpId,impId,
...
//显示参数
     ...
     for(int i=0;i<resultList.size();i++){
         ...
         String dataStr = PageHelper.addElement("media-name",objs[0]);
     ...
     pageHelper.outPut(out,sbData.toString(),"1010-80-0065-20041025",
             "no any error","",
