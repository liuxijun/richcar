...
import="cn.sh.guanghua.util.tools.*" %><%
    ...
    //计算分页相关参数
    if(lTotalRows == 0){
        lTotalRows = MediaLogic.searchPublishedMediasCount(searchname,searchsort);
    }
    ...
    result = MediaLogic.searchPublishedMedias(searchname, searchsort, lStartRow,lSelectedRowCount );
