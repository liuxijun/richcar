...
%><%@ page import="java.util.Date,
 ...
 contentType="text/html;charset=gb2312" %><%
    ...
    //定义数据访问变量
     ...
     String orderBy = ParamTools.getParameter(request,"order_by","mlh.medialogIcpid");
     ...
     searchHelper = getUserIcpLog(channelId,userid,startTime,endTime,icpId,
...
//显示参数
 ...
 %><%!
    public static SearchHelper searchlimiticp(long channelId,String userId,
     ...
     public static SearchHelper getUserIcpLog(long channelId,String userId,
                                                    long startTime,long endTime,
         ...
         try{
             ...
             String baseHql1 = "";
             baseHql1 = " select mlh.medialogIcpid ,count(mlh.medialogId) ,sum(mlh.orderLength)  "+baseHql;
             baseHql1 += " group by mlh.medialogIcpid ";
             ...
             System.out.println(SearchHelper.translateToSQL(orderHql));
