...
%><%@ page import="java.util.Date,
 ...
 contentType="text/html;charset=gb2312" %><%
    ...
    //定义数据访问变量
     ...
     searchHelper = getUserMediaLog(channelId,userid,startTime,endTime,-1,-1,
...
//显示参数
 ...
 %><%!
    public static SearchHelper searchlimit(long channelId,String userId,
     ...
     public static SearchHelper getUserMediaLog(long channelId,String userId,
                                                    long startTime,long endTime,
                                                    long icpId,long impId,
         ...
         try{
             ...
             String baseHql1 = "";
             baseHql1 = " select m.mediaName ,count(mlh.medialogId) ,sum(mlh.orderLength)  "+baseHql;
             baseHql1 += " group by m.mediaName ";
