...
//免费影片（费用为0）的影片直接播放
                 ...
                 && !sessionId.equals("null"))
    {
        ...
        out.println("</head>");
        out.println("<body topmargin='0'' leftmargin='0' onload='window.resizeTo(510,335)'>");
...
//        out.println("		</td>");
        ...
        out.println("　　1 如您已经是山西联通在宽带三晋II网站注册用户，<a href='http://kdsj2.sx.cn' target='_blank'>首页</a>登陆后即可订购<br>　观看；<br>　");
        ...
        out.println("　2006年12月1日—2006年12月31日，凡是山西联通用户在本网站订购九州<br>　影院、九州剧场、动漫帝国三频道，均可免费收看。");
        out.println("		</td>");
        out.println("	</tr>");
        out.println("</table>");
        out.println("</body>");
