...
<%
    ...
    String actionHeader = "admin";
    {
        ...
        needPermissions(actionHeader,"view","systemServiceProductManage,serviceProductView");
...
var radioGroups = new Ext.form.RadioGroup({
    xtype:'radiogroup',
    ...
    buttons:[
        {
            ...
            text:'确定',
            handler:function () {
                var productNo = Ext.getCmp('selectProduct');
                productNo.eachItem(function (item) {
                    if (item.checked === true) {
                        Ext.getCmp("productBtn").setText(item.boxLabel);
                        Ext.getCmp("obj.productId").setValue(item.inputValue);
                    }
                    win.hide();
                })
        ...
        items:[
            {
                ...
                items:[
                    ...
                    <%--method:'POST',--%>
                    <%--url:"/product/product!getAllProductOfStatus.action?limit=10000",--%>
                    <%--root:'objs',--%>
                    <%--fields:['id','name'],--%>
                    <%--readOnly:viewReadOnly,--%>
                    <%--autoLoad:true--%>
