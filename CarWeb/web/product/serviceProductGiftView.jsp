            ...
            var serviceProductGiftViewForm = new FortuneViewForm({
                ...
                items:[
                    //{name:'keyId',value:keyId,inputType:'hidden'},
                     ...
                     {fieldLabel:'<fts:text name="serviceProductGift.serviceProductId"/>',name:'obj.serviceProductId',readOnly:viewReadOnly}                     ,
                     {fieldLabel:'<fts:text name="serviceProductGift.giftServiceProductId"/>',name:'obj.giftServiceProductId',readOnly:viewReadOnly}                     ,
                     {fieldLabel:'<fts:text name="serviceProductGift.startTime"/>',name:'obj.startTime',readOnly:viewReadOnly}                     ,
                     {fieldLabel:'<fts:text name="serviceProductGift.endTime"/>',name:'obj.endTime',readOnly:viewReadOnly}
                ]
            });
            loadFormAjax();
