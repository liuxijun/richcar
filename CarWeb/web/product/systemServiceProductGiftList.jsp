<%@ taglib prefix="s" uri="/struts-tags" %><%@ taglib prefix="fts" uri="/WEB-INF/tlds/fortune-tags.tld" %><%@ taglib
    ...
    //初始化本页权限需求
    String actionHeader = "systemServiceProductGift";
    {
...
<head>
    ...
    window.location.href = "systemServiceProductGiftView.jsp";
}
    ...
    },
    {
        ...
        function initDisplay(){
            ...
            var columns = new Ext.grid.ColumnModel([
                ...
                {header: "<fts:text name="serviceProductGift.serviceProductId"/>",hidden:false, align:'center', width: 80, sortable: true,dataIndex: 'serviceProductId'}                ,
                {header: "<fts:text name="serviceProductGift.giftServiceProductId"/>",hidden:false, align:'center', width: 90, sortable: true,dataIndex: 'giftServiceProductId'}                ,
                {header: "<fts:text name="serviceProductGift.startTime"/>",hidden:false, align:'center', width: 90, sortable: true,dataIndex: 'startTime'}                ,
                {header: "<fts:text name="serviceProductGift.endTime"/>",hidden:false, align:'center', width: 90, sortable: true,dataIndex: 'endTime'},
