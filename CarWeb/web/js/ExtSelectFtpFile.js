 ...
 */
Ext.ns('Ext.fortune.grid');

/**
 * @class Ext.fortune.grid.FtpFileSelect
 ...
 *
 * @constructor
 * Create a new FtpFileSelect
 * @param {Object} config Configuration options
 * @xtype ftpfileselect
 */
Ext.fortune.grid.FtpFileSelect = Ext.extend(Ext.grid.GridPanel,  {
    /**
     * @cfg {String} legend Wraps the object with a fieldset and specified legend.
     */
    /**
     * @cfg {Ext.ListView} view The {@link Ext.ListView} used to render the FtpFileSelect list.
     */
    /**
     * @cfg {String/Array} dragGroup The ddgroup name(s) for the FtpFileSelect DragZone (defaults to undefined).
     */
    /**
     * @cfg {String/Array} dropGroup The ddgroup name(s) for the FtpFileSelect DropZone (defaults to undefined).
     */
    /**
     * @cfg {Boolean} ddReorder Whether the items in the FtpFileSelect list are drag/drop reorderable (defaults to false).
     */
    ddReorder:false,
    /**
    ...
    delimiter:',',
    /**
     * @cfg {Ext.data.Store/Array} store The data source to which this FtpFileSelect is bound (defaults to <tt>undefined</tt>).
    ...
    initComponent: function(){
        Ext.fortune.grid.FtpFileSelect.superclass.initComponent.call(this);
    ...
    onRender: function(ct, position){
        Ext.fortune.grid.FtpFileSelect.superclass.onRender.call(this, ct, position);
    ...
    afterRender: function(){
        Ext.fortune.grid.FtpFileSelect.superclass.afterRender.call(this);

        if (this.ddReorder && !this.dragGroup && !this.dropGroup){
            this.dragGroup = this.dropGroup = 'FtpFileSelectDD-' + Ext.id();
        }

        if (this.draggable || this.dragGroup){
            this.dragZone = new Ext.fortune.grid.FtpFileSelect.DragZone(this, {
                ddGroup: this.dragGroup
            });
        }
        if (this.droppable || this.dropGroup){
            this.dropZone = new Ext.fortune.grid.FtpFileSelect.DropZone(this, {
    ...
    destroy: function(){
        ...
        Ext.fortune.grid.FtpFileSelect.superclass.destroy.call(this);
    }
});


Ext.reg('FtpFileSelect', Ext.fortune.grid.FtpFileSelect);

//backwards compat
Ext.fortune.FtpFileSelect = Ext.fortune.grid.FtpFileSelect;


Ext.fortune.grid.FtpFileSelect.DragZone = function(ms, config){
    this.ms = ms;
    this.view = ms.view;
    var ddGroup = config.ddGroup || 'FtpFileSelectDD';
    var dd;
    ...
    Ext.fortune.grid.FtpFileSelect.DragZone.superclass.constructor.call(this, this.ms.fs.body, { containerScroll: true, ddGroup: dd });
    this.setDraggable(ddGroup);
};

Ext.extend(Ext.fortune.grid.FtpFileSelect.DragZone, Ext.dd.DragZone, {
...
Ext.fortune.grid.FtpFileSelect.DropZone = function(ms, config){
    this.ms = ms;
    this.view = ms.view;
    var ddGroup = config.ddGroup || 'FtpFileSelectDD';
    var dd;
    ...
    Ext.fortune.grid.FtpFileSelect.DropZone.superclass.constructor.call(this, this.ms.fs.body, { containerScroll: true, ddGroup: dd });
    this.setDroppable(ddGroup);
};

Ext.extend(Ext.fortune.grid.FtpFileSelect.DropZone, Ext.dd.DropZone, {
    /**
    ...
    onNodeDrop : function(n, dd, e, data){
        ...
        // Validate if dragging within the same FtpFileSelect
