...
Ext.onReady(function(){
                            ...
                            },
                            {
                                ...
                                items:[{
                                    ...
                                    handler:function(){
                                        ...
                                        form.action = '/log/visitLog!contentLogs.action?type=2&limit=20&excel=isTrue&dir=desc';
                                        form.method = 'POST';
                                        form.target = "_blank" ;
                                        form.submit();
                                    }
    ...
    var dataListStore = new Ext.data.JsonStore({
        method:'POST',
        remoteSort: true,
        url: actionUrl + "!contentLogs.action?type=2",
    ...
    var listGrid = new Ext.grid.GridPanel({
        ...
        columns: [
            ...
            {header: "播放次数", dataIndex: 'vl_count', width: 70, sortable: true, align:'center'},
            ...
            {header: "播放时长", dataIndex: 'vl_length', width: 70, sortable: true, align:'center'} ,
