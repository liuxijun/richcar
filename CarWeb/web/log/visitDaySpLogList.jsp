<%@ taglib prefix="s" uri="/struts-tags" %><%@ taglib prefix="fts" uri="/WEB-INF/tlds/fortune-tags.tld" %><%@ taglib
    ...
    //初始化本页权限需求
    String actionHeader = "visitDaySpLog";
    {
...
<head>
    ...
    <script type="text/javascript">
        ...
        function initDisplay(){
            storeConfig.fields = ['id','spId','day','count','length'];
            ...
            var columns = new Ext.grid.ColumnModel([
                ...
                {header: "<fts:text name="visitDaySpLog.spId"/>",hidden:false, align:'center', width: 60, sortable: true,dataIndex: 'spId'}                ,
                {header: "<fts:text name="visitDaySpLog.day"/>",hidden:false, align:'center', width: 60, sortable: true,dataIndex: 'day'}                ,
                {header: "<fts:text name="visitDaySpLog.count"/>",hidden:false, align:'center', width: 60, sortable: true,dataIndex: 'count'}                ,
                {header: "<fts:text name="visitDaySpLog.length"/>",hidden:false, align:'center', width: 60, sortable: true,dataIndex: 'length'},
            ...
            checkAllFunctions();  // 检查用户权限
            var visitDaySpLogGrid = new FortuneSearchListGrid({
                title:'<fts:text name="visitDaySpLog"/>列表',
                sm : sm,
                cm:columns,
                store:searchStore,
            ...
            visitDaySpLogGrid.render(displayDiv);
            defaultGrid = visitDaySpLogGrid;
