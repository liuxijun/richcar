...
Ext.onReady(function(){
                            ...
                            },
                            {
                                ...
                                items:[{
                                    ...
                                    handler:function(){
                                        ...
                                        form.action = '/log/visitLog!contentFilmAndTvLogs.action?contentType=1&excel=isTrue';
                                        form.method = 'POST';
                                        form.target = "_blank" ;
                                        form.submit();
                                    }
    ...
    var dataListStore = new Ext.data.JsonStore({
        method:'POST',
        remoteSort: true,
        url: actionUrl + "!contentFilmAndTvLogs.action?contentType=1",
        totalProperty:"totalCount",
        root:'objs',
        fields:[
            {name:'vl_spId'},
                ...
                if (objs){
                    ...
                    if (ids!=''){
                        ...
                        remoteRequestStore.reload({
                            params:{keyIds:ids,limit:10000000},
                            callback :
                                    function(records,options,success){
