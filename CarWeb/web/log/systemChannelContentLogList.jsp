...
Ext.onReady(function(){
                            ...
                            },
                            {
                                ...
                                items:[{
                                    ...
                                    handler:function(){
                                        ...
                                        form.action = '/log/visitLog!channelContentLogs.action?excel=isTrue&orderBy=desc';
                                        form.method = 'POST';
                                        form.target = "_blank" ;
                                        form.submit();
                                    }
    ...
    var dataListStore = new Ext.data.JsonStore({
        method:'POST',
        remoteSort: true,
        url: actionUrl + "!channelContentLogs.action",
        totalProperty:"totalCount",
        root:'objs',
        fields:[
            {name:'vl_spId'},
    ...
    function initSpCombo(){
        ...
        var obj = searchForm.getForm().findField('vl_channelId');
        obj.clearValue();
    ...
    var listGrid = new Ext.grid.GridPanel({
        ...
        sm:checkSelect,
        columns: [
            {header: "SP名称", dataIndex: 'vl_spId', width:120, sortable: true, align:'center',
            ...
            {header: "频道", dataIndex: 'vl_channelId', width:150, sortable: true, align:'center',
                renderer:function(val,p,row){
            ...
            {header: "资源名称", dataIndex: 'vl_contentId', width:130, sortable: true, align:'center',
                renderer:function(val,p,row){
