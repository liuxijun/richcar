...
<div id="main_list" style="height:630px;">
    <table cellpadding="0" cellspacing="0" class="t_list" id="2333">
        ...
        <%
            ...
            if(objMaps!=null){
                List objLists = (List) objMaps.get("resourceOnDemand");
                for(int i=0;i<objLists.size();i++){
                    Map<String,Object> resourceOnDemandMap = (Map<String, Object>) objLists.get(i);
        %>

        <tr>
            <td>
                <%=resourceOnDemandMap.get("cp_name")%>&nbsp;
            </td>
            <td>
                <%=resourceOnDemandMap.get("channel_name")%>&nbsp;
            </td>
            <td>
                <%=resourceOnDemandMap.get("content_name")%>&nbsp;
            </td>
            <td>
                <%=resourceOnDemandMap.get("play_num")%>&nbsp;
            </td>
        </tr>
        <%
                }
...
%>
<form id="form1" name="form1" action="/log/visitLog!getResourceOnDemandCount.action" method="post">
    <%
        PageBean pageBean = (PageBean) request.getAttribute("pageBean");
        String startTime="",endTime="",contentName="",channelName="",playTime="";
        long spId;
