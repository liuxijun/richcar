...
<head>
    ...
    <script type="text/javascript">
        ...
        function initDisplay(){
            storeConfig.fields = ['id','cspId','deviceId'];
            ...
            var columns = new Ext.grid.ColumnModel([
                ...
                {header: "<fts:text name="cspDevice.cspId"/>",hidden:false, align:'center', width: 60, sortable: true,dataIndex: 'cspId'}                ,
                {header: "<fts:text name="cspDevice.deviceId"/>",hidden:false, align:'center', width: 60, sortable: true,dataIndex: 'deviceId'},
            ...
            checkAllFunctions();  // 检查用户权限
            var cspDeviceGrid = new FortuneSearchListGrid({
                title:'<fts:text name="cspDevice"/>列表',
                sm : sm,
                cm:columns,
                store:searchStore,
            ...
            cspDeviceGrid.render(displayDiv);
            defaultGrid = cspDeviceGrid;
