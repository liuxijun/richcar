<%@ taglib prefix="s" uri="/struts-tags" %><%@ taglib prefix="fts" uri="/WEB-INF/tlds/fortune-tags.tld" %><%@ taglib
    ...
    //初始化本页权限需求
    String actionHeader = "cspProduct";
    {
...
<head>
    ...
    <title><fts:text name="cspProduct"/>管理</title>
    <%@include file="../inc/jsCssLib.jsp"%>
    <%@include file="../inc/extBase.jsp"%>
    <script type="text/javascript">
        nextUrl = "cspProductList.jsp";
        actionHeader = "cspProduct";
        checkAllFunctions();  // 检查用户权限
        function initDisplay(){
            storeConfig.fields = ['id','cspId','productId'];
            ...
            var columns = new Ext.grid.ColumnModel([
                ...
                {header: "<fts:text name="cspProduct.cspId"/>",hidden:false, align:'center', width: 60, sortable: true,dataIndex: 'cspId'}                ,
                {header: "<fts:text name="cspProduct.productId"/>",hidden:false, align:'center', width: 60, sortable: true,dataIndex: 'productId'},
            ...
            checkAllFunctions();  // 检查用户权限
            var cspProductGrid = new FortuneSearchListGrid({
                title:'<fts:text name="cspProduct"/>列表',
                sm : sm,
                cm:columns,
                store:searchStore,
            ...
            cspProductGrid.render(displayDiv);
            defaultGrid = cspProductGrid;
