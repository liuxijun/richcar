...
<script type="text/javascript">
    var carId = <%=carId%>;
    var conductId = <%=StringUtils.string2int(request.getParameter("conductId"),-1)%>;
    try {
            ...
            <div class="row page-content-main">
                ...
                <form role="form" class="form-horizontal">
                    ...
                    <div class="col-xs-12 no-padding movie-info">
                        ...
                        <div class="row">
                            <div class="col-md-2"><a class="btn btn-green btn-big" href="conductView.jsp?carId=<%=carId%>">新增检查</a></div>
