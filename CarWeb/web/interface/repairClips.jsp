<%@ page import="java.io.File" %><%@ page import="com.fortune.util.FileUtils" %><%@ page
        import="java.util.List" %><%@ page import="com.fortune.util.XmlUtils" %><%@ page
        import="org.dom4j.Node" %><%@ page import="org.apache.log4j.Logger" %><%@ page
...
<%@ page import="com.fortune.rms.business.module.model.Property" %>
...
--%><%@ page contentType="text/html;charset=UTF-8" language="java" %><%
    ...
    for(File xmlFile:xmlFiles){
        ...
        if(!(xmlFileName.contains("error.xml"))){
            continue;
        }
        ...
        if(root!=null){
            ...
            for (Object node : allContentNodes) {
                ...
                //所有的源连接
                List<ContentProperty> clips = contentPropertyLogicInterface.search(cp);
