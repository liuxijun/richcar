...
<head>
  ...
  <meta charset="utf-8"/>
  <title>录制编辑 - <%=IndividualUtils.getInstance().getName()%></title>
  ...
  <div class="main-content">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="record.jsp">录制管理</a></li>
        <li class="active">录制编辑</li>
      </ul>
      <!-- /.breadcrumb -->
    ...
    <div class="page-header">
      <h1>
        <i class="ace-icon fa fa-edit"></i>录制属性
      </h1>
    </div>
    <!-- /.page-header -->
    <div class="page-content">
      <div class="page-content-area">
        <div class="row page-content-main">
          <div class="col-md-12">
            <h4 id="stepTitle">1.录制任务（对应统一转码平台的任务）</h4>
            <div class="tabbable ">
                                ...
                                <div id="taskDetail" class="row page-content-main">
                                  <div class="col-xs-12 no-padding">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10 checkbox" id="taskRecordTemplateContainer">
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10" id="taskTimeContainer">
                                        <div class="btn-group" data-toggle="buttons">
                                          ...
                                          <label class="btn btn-blue2 border-radius-r-5" id="taskTypeLoop">
                  ...
                  <form class="form-horizontal">
                    <div class="row page-content-main">
                      <div class="form-group">
                        ...
                        <div class="col-sm-5">
                          <input type="text" class="col-sm-10" id="recordTitle" maxlength="64" style="display:inline-block">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-5">
                          <input type="text" class="col-sm-10" id="recordActor" maxlength="64">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <div class="col-sm-5 no-padding">
                            <div class="file-thumb" id="recordPoster"><i></i></div>
                  ...
                  <form class="form-horizontal">
                    <div class="row page-content-main">
                      <div class="form-group">
                        ...
                        <div id="record_channel" class="tree">
            ...
            <div class="modal-body">
              <form class="form-horizontal">
                <div style="min-height: 240px;line-height: 30px">
                  <ul>
                    <li>录制的名称自动匹配只有在定时循环任务执行时才会生效；</li>
                    <li>{YYYY} 在发布时会替换为4位年份，如2009年；</li>
                    <li>{MM} 在发布时会替换为2位月份，如04月；</li>
                    <li>{DD} 在发布时会替换为2位日，如28日；</li>
                    <li>{E} 在发布时会替换为周几，如周一。</li>
                  </ul>
                  <span style="margin-left:20px;display:block">
                  例：<i>{YYYY}年{MM}月{DD}日 新闻联播</i>，在2015-3-27发布时会自动命名为“<b>2015年03月27日 新闻联播</b>”；<br/>
                  <i>{E}{MM}.{DD}《走进伪科学》</i>，在2015-3-27发布时会自动命名为“<b>周五03.27《走进伪科学》</b>”。
                    </span>
                </div>
      ...
      <script type="text/javascript">
        var global_step = 1;
        var STEP_TITLE_FIRST = "1.录制任务（对应统一转码平台的任务）",
                STEP_TITLE_SECOND = "2.录制描述",
                STEP_TITLE_THIRD = "3.录制栏目";
        ...
        jQuery(function ($) {
          ...
          $("#taskTypeOneTime").click(function(){
            $("#loopPanel").removeClass("active").removeClass("in").hide();
            $("#oneTimePanel").addClass("active").addClass("in").show();
            $("#btn-reg-instruction").hide();
          });
          $("#taskTypeLoop").click(function(){
            $("#oneTimePanel").removeClass("active").removeClass("in").hide();
          ...
          "#loopEndDate input, #recordTitle, #id-input-file-poster").change(function(){
            $(this).closest("div.form-group").removeClass("has-error");
          });
          $("#taskName, #taskSource, #loopStartTime input,#loopEndTime input, #loopStartDate input," +
          "#loopEndDate input, #recordTitle, #id-input-file-poster").keypress(function() {
            $(this).closest("div.form-group").removeClass("has-error");
          });
        ...
        function createNewTask(){
          ...
          // 保存任务
          liveUtils.saveTask(task, createTaskSucceed, retrieveDataError,liveUtils.TASK_MODE_RECORD);
        }
        ...
        function createTaskSucceed(taskId){
          ...
          liveUtils.saveRecord(serializeRecord(),recordSaveSucceed, retrieveDataError);
        }
        ...
        function showLiveInfo(live){
          ...
          $("#recordTitle").val(live.title);
          $("#cb-auto-control").prop("checked", live.autoControl);
          $("#recordActor").val(live.actor);
          $("#recordIntro").val(live.intro);
          // 海报
          //var content = $('<span>').append($('<img>').attr('src', live.poster));
          //$("#recordPoster").children().replaceWith(content);
          ...
          // 选中直播所属的栏目和录制栏目
          show_tree($("#record_channel"), live.channels);
...
/*
            $("#taskTable tbody").prepend(myTmpl("tmpl-task", task));
...
*/
        ...
        function myTmpl(id,obj){
        //    console.info("准备调用："+id);
            var result = tmpl(id,obj);
        //    console.info("调用结束："+id);
            return result;
        }
        // 显示配置选项
        function showTemplateList(templateList){
          ...
          var panel = $("#taskRecordTemplateContainer"), i;
          panel.html("");
          console.info("showTemplateList");
          // 录制文件
          for(i=0; i<templateList.length; i++){
            if(templateList[i].type != "file") continue;
            panel.append(myTmpl("tmpl-template-record" ,templateList[i]));
          }
            console.info("tmpl-template-record finished");
          bindEvent();
          // 可以加载直播
          liveUtils.dataInitProgress++;
          if( liveUtils.dataInitProgress >= liveUtils.LIVE_INIT_MIN_PROGRESS &&
        ...
        function showTasks(taskList, totalCount){
          ...
          for(var i=0; i<taskList.length; i++) {
            ...
            if(tab.find("input[name='selectTask'][value='" + taskList[i].id + "']").length == 0) {
              s = myTmpl("tmpl-task-header", t);
              if(t.isLive()){
                s += myTmpl("tmpl-mark-live", t);
              }
              if(t.isRecord()){
                s += myTmpl("tmpl-mark-record", t);
              }
              s+= myTmpl("tmpl-task-tail", t);
              tab.append(s);
            }
          }
          $('[data-rel=tooltip]').tooltip();
        ...
        // 从统一转码取数据失败
        function retrieveDataError(message,notNeedReload){
            alert(message);
            if(!notNeedReload){
                reloadThisPage();
            }
        ...
        function doSave(){
          if(checkInput()){
            console.info("录制信息检查已经通过，正在准备保存");
            ...
            if($("#task-new").hasClass("active")){
              ...
              if(!task || !task.isRecord()){
                moveToStep(1);
                alert("选择的任务不支持录制，请重新选择或新建任务。");
                return false;
              }else {
                liveUtils.saveTask(task, createTaskSucceed, retrieveDataError,
                        liveUtils.TASK_MODE_RECORD);
              }
            }
          }
        }
        ...
        // 返回列表页面
        function recordSaveSucceed(){
          location.href = "record.jsp";
        }
        ...
        function serializeRecord(){
          ...
          var poster = $("#recordPoster").find('img, canvas'),
          ...
          return {"id" : liveUtils.itemId,
            ...
            "actor": $("#recordActor").val(),
            "poster": posterData,
            "intro": $("#recordIntro").val(),
            "serializedChannel": $('#record_channel').tree('selectedItems'),
        ...
        function checkInput(){
          ...
          if($("#task-synch").hasClass("active")){
            ...
            // 检查新建任务是否输入完整
            var textInputList = [$("#taskName")], checkboxList = [$("input[name='taskTemplates']")];
          ...
          // 直播描述信息
          missed = (liveUtils.itemId >0 )? textHasEmptyItem([$("#recordTitle")]) : textHasEmptyItem([$("#recordTitle"), $("#id-input-file-poster")]);
          if(missed){
            moveToStep(2);
            return false;
          }
          ...
          // 栏目和用户类型
          var liveChannels = $('#record_channel').tree('selectedItems');
          missed = (liveChannels.length == 0);
          if(missed){
            $('#record_channel').closest("div.form-group").addClass("has-error");
          }
          ...
          $.ajax({
            ...
            success: function(msg){
              ...
              for(var i=0; i<response.objs.length; i++){
                ...
                if(type){
                  $("#user-type-container").append(myTmpl("tmpl-user-type", type));
                }
              }
              bindEvent();
              liveUtils.dataInitProgress++;
        ...
        function bindEvent(){
          ...
          /*
           ...
           if(template){
           $(this).tooltip('option', 'content', myTmpl("tmpl-template-detail", template));
           }
           }
           });
           */
