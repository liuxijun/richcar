...
<head>
    ...
    <meta charset="utf-8"/>
    <title>栏目内容 - <%=IndividualUtils.getInstance().getName()%></title>
...
<div class="page-header">
    <h1>
        <i class="ace-icon fa fa-list"></i>内容一览
                ...
                <div class="col-xs-12 no-padding movie-info">
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" id="channel-content">

                            </div>

                            <div class="tab-pane fade active in" id="class-content">
    ...
    <div class="modal-dialog" style="position: relative; top: 40px;width: 560px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="destPage" value="3">
            </div>
            </form>
...
<script type="text/javascript">
    ...
    function get_content(){
        ...
        $.ajax({
            type: "POST",
            url: "/content/getChannelList.action",
            //dataType: "json",
            dataType: "text",
                ...
                for (var n = 0; n < response.objs.length; n++) {
                    ...
                    if (o) {
                        ...
                        if(parseInt(o.c_status) != _STATUS_ONLINE){
                            td_html += '<a class="btn btn-grey btn-xs" data-rel="tooltip" data-original-title="编辑" data-placement="bottom" href="#" onclick="show_edit_dialog(' + o.c_id + ');return false;"><i class="ace-icon fa fa-edit bigger-110 icon-only"></i></a>';
                        }
                        if(parseInt(o.c_status) == _STATUS_ONLINE){
