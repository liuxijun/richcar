!function (e, t) {
    ...
    var o = function () {
        ...
        return s.onload = function (s) {
            ...
            e(o).one("load", function () {
                ...
                var c = l.w, u = l.h;
                "small" == a.settings.thumbnail && (c = u = s), e(o).css({"background-image": "url(" + l.src + ")", width: c, height: u}).data("thumb", l.src).attr({src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg=="}).show(), n.resolve()
            }).one("error", function () {
        ...
        var b;
        return this.$element.trigger(b = new e.Event("file.error.ace"), {file_count: t.length, invalid_count: t.length - c.length, error_list: d, error_count: m, dropped: a}), b.isDefaultPrevented() ? -1 : c
    };
    ...
    }, e.fn.bs_typeahead.defaults = {source: [], items: 8, menu: '<ul class="typeahead dropdown-menu"></ul>', item: '<li><a href="#"></a></li>', minLength: 1}, e.fn.bs_typeahead.Constructor = t, e.fn.bs_typeahead.noConflict = function () {
    ...
    e.fn.ace_wysiwyg = function (t) {
        ...
        return this.each(function () {
            ...
            t += " </div> ";
            var u;
            a.speech_button && "onwebkitspeechchange"in(u = document.createElement("input")) && (t += ' <input class="wysiwyg-speech-input" type="text" data-edit="inserttext" x-webkit-speech />'), u = null, t += " </div> ", t = a.toolbar_place ? a.toolbar_place.call(this, t) : e(this).before(t).prev(), t.find("a[title]").tooltip({animation: !1, container: "body"}), t.find(".dropdown-menu input[type=text]").on("click", function () {
                return!1
            }).on("change", function () {
            ...
            t.find("a[data-view=source]").on("click", function (t) {
                ...
                } else e("<textarea />").css({width: h.outerWidth(), height: h.outerHeight()}).val(h.html()).insertAfter(h), h.hide(), e(this).addClass("active");
                f = !f
            });
