...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      case 'modal':
        template = '<div class="bootstrap-timepicker-widget model hide fade in" data-backdrop="'+ (this.modalBackdrop ? 'true' : 'false') +'">'+
          '<div class="model-header">'+
            '<a href="#" class="close" data-dismiss="model">×</a>'+
            '<h3>Pick a Time</h3>'+
          '</div>'+
          ...
          '<div class="model-footer">'+
            '<a href="#" class="btn btn-primary" data-dismiss="model">OK</a>'+
          '</div>'+
        '</div>';
        break;
      case 'dropdown':
