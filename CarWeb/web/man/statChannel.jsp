...
<head>
  ...
  <meta charset="utf-8"/>
  <title>频道访问统计 - <%=IndividualUtils.getInstance().getName()%></title>
...
<div class="main-container" id="main-container">
  ...
  <div class="main-content">
    ...
    <div class="page-header">
      <h1>
        <i class="ace-icon fa fa-bar-chart"></i>频道访问统计
      </h1>
    </div>
    <!-- /.page-header -->
    <div class="page-content">
          ...
          <div class="col-md-12">
            <div class="tabbable ">
              ...
              <div class="tab-content no-border">
                <div id="tab1" class="tab-pane fade fade">
                  ...
                  <div class="row">
                    <form role="form" class="form-horizontal">
                      ...
                      <div class="cos-md-12">
                        ...
                        <div class="tabbable" id="channel_stat_panel">
      ...
      <script src="../scripts/channel.js?v=3.423"></script>
      ...
      <script type="text/javascript">
        ...
        var statUtils = {
          ...
          getData : function(){
            $.ajax({
              type: "POST",
              url: "/log/statChannel.action",
              data : {"startTime": statUtils.startTime, "endTime":statUtils.endTime},
              dataType: "text",
              success: function(msg){
                //var response = eval("(function(){return " + msg + ";})()");
                statUtils.channelUtils.resetAllVisitCount();

                var response = JSON.parse(msg);
                for (var i = 0; i < response.objs.length; i++) {
                  var o = response.objs[i];
                  statUtils.channelUtils.setChannelVisitCount(o.channelId, o.visitCount);
                }

                // 显示
                $("#channel_stat_panel").html(statUtils.channelUtils.generateStat());
              }
            });
          },
